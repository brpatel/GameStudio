package com.citrusengine.core {
	...
	public class StarlingState extends Sprite implements IState {
		...
		public var _isReplayMode:Boolean = false;
		
		public function get isReplayMode():Boolean
		{
			return _isReplayMode;
		}
		
		public function set isReplayMode(replayMode:Boolean)
		{
		...
		public function getAllObjects():Vector.<CitrusObject>
		{
