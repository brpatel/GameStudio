	...
	public class ObjectMaker
	{
		...
		public static function FromLevelArchitect(levelData:XML, addToCurrentState:Boolean = true):Array
		{
			...
			for each (var objectXML:XML in levelData.CitrusObject)
			{
				...
				/*if(theObject is Platform){
					Platform(theObject).x = Platform(theObject).x + (Platform(theObject).width/2);
					Platform(theObject).y = Platform(theObject).y + (Platform(theObject).height/2);
				}*/
