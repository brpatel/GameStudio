...
package mx.messaging.messages
{
    public class MessagePerformanceUtils 
    {
        ...
        public function MessagePerformanceUtils(_arg1:Object):void
        {
            ...
            if ((((this.mpio == null)) || ((((this.mpii == null)) && ((_arg1.headers[MPI_HEADER_PUSH] == null))))))
            {
        ...
        public function prettyPrint():String
        {
            ...
            {
                _local1 = (_local1 + (("Original message size(B): " + this.messageSize) + "\n"));
            };
            if (this.responseMessageSize != 0)
            {
                _local1 = (_local1 + (("Response message size(B): " + this.responseMessageSize) + "\n"));
            };
            if (this.totalTime != 0)
            {
                _local1 = (_local1 + (("Total time (s): " + (this.totalTime / 1000)) + "\n"));
            };
            if (this.networkRTT != 0)
            {
                _local1 = (_local1 + (("Network Roundtrip time (s): " + (this.networkRTT / 1000)) + "\n"));
            };
            if (this.serverProcessingTime != 0)
            {
                _local1 = (_local1 + (("Server processing time (s): " + (this.serverProcessingTime / 1000)) + "\n"));
            };
            if (this.serverAdapterTime != 0)
            {
                _local1 = (_local1 + (("Server adapter time (s): " + (this.serverAdapterTime / 1000)) + "\n"));
            };
            if (this.serverNonAdapterTime != 0)
            {
                _local1 = (_local1 + (("Server non-adapter time (s): " + (this.serverNonAdapterTime / 1000)) + "\n"));
            };
            if (this.serverAdapterExternalTime != 0)
            {
                _local1 = (_local1 + (("Server adapter external time (s): " + (this.serverAdapterExternalTime / 1000)) + "\n"));
            };
            if (this.pushedMessageFlag)
            {
                ...
                {
                    _local1 = (_local1 + (("Total push time (s): " + (this.totalPushTime / 1000)) + "\n"));
                };
                if (this.pushOneWayTime != 0)
                {
                    _local1 = (_local1 + (("Push one way time (s): " + (this.pushOneWayTime / 1000)) + "\n"));
                };
                if (this.originatingMessageSize != 0)
                {
                    _local1 = (_local1 + (("Originating Message size (B): " + this.originatingMessageSize) + "\n"));
                };
                if (this.serverPollDelay != 0)
                {
                    _local1 = (_local1 + (("Server poll delay (s): " + (this.serverPollDelay / 1000)) + "\n"));
                };
            };
            return (_local1);
        }
