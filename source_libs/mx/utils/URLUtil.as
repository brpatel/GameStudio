...
package mx.utils
{
    ...
    public class URLUtil 
    {
        ...
        public static function getServerName(_arg1:String):String
        {
            ...
            var _local3:int = URLUtil.indexOfLeftSquareBracket(_local2);
        ...
        public static function replaceTokens(_arg1:String):String
        {
            ...
            {
                _local2 = URLUtil.replaceEncodedSquareBrackets(_local2);
        ...
        public static function hasTokens(_arg1:String):Boolean
        {
            if ((((_arg1 == null)) || ((_arg1 == ""))))
            {
                return (false);
            ...
            if (_arg1.indexOf(SERVER_PORT_TOKEN) > 0)
            {
                return (true);
            };
            return (false);
        ...
        private static function indexOfLeftSquareBracket(_arg1:String):int
        {
            var _local2:int = _arg1.indexOf(SQUARE_BRACKET_LEFT);
            if (_local2 == -1)
            {
                _local2 = _arg1.indexOf(SQUARE_BRACKET_LEFT_ENCODED);
            };
            return (_local2);
        }
        ...
        private static function replaceEncodedSquareBrackets(_arg1:String):String
        {
            var _local3:int;
            var _local2:int = _arg1.indexOf(SQUARE_BRACKET_RIGHT_ENCODED);
            if (_local2 > -1)
            {
                _arg1 = _arg1.replace(SQUARE_BRACKET_RIGHT_ENCODED, SQUARE_BRACKET_RIGHT);
                _local3 = _arg1.indexOf(SQUARE_BRACKET_LEFT_ENCODED);
                if (_local3 > -1)
                {
                    _arg1 = _arg1.replace(SQUARE_BRACKET_LEFT_ENCODED, SQUARE_BRACKET_LEFT);
                };
            };
            return (_arg1);
        }
