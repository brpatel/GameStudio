 ...
 */       private var _textInput:InputOverlay;
 // For level editor
 		private var _btnBGImage:BlueButton;
 		private var _addBgImage:Signal;

        public function GameSetupScreen()
        {
		...
		public function get addBgImage():Signal
		{
			return (this._addBgImage);
		}
 ...
 /*           var textField:TextField = Common.labelField(120, 30, Common.getResourceString("label_base_form"));
            ...
            addChild(separator);*/
			var textField:TextField  = Common.labelField(200, 30, Common.getResourceString("label_base_measure"));
            ...
            textField.y = 72;
            addChild(textField);
            textField = Common.labelField(30, 30, "px");
			textField.color = 0xFFFFFF;
            textField.x = 200;
            textField.y = 72;
            addChild(textField);
            ...
            this._btnReset.x = 23;
            this._btnReset.y = 304;
            this._btnReset.onRelease.add(this.btnReset_onRelease);
            this.addChild(this._btnReset);
			
			var separator:Image = Common.separator(14, 360, 232, "sidebar");
			addChild(separator);
			
			this._btnBGImage = new BlueButton();
			this._btnBGImage.label = Common.getResourceString("btnBgImage");
			this._btnBGImage.width = 187;
			this._btnBGImage.x = 23;
			this._btnBGImage.y = 380;
			this._btnBGImage.onRelease.add(this.btnBGImage_onRelease);
			this.addChild(this._btnBGImage);
		...
		private function btnBGImage_onRelease(_arg1:Button):void
		{
			_addBgImage.dispatch();
		}
