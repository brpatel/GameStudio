package com.adobe.gamebuilder.editor.view.screens
{
    ...
    public class ModelScreen extends Screen implements IDragSource 
    {
        ...
        private var _btnRelease:Object;
        private var _openLink:ImageButton;

        public function ModelScreen()
        {
        ...
        public function init(_arg1:Array, _arg2:Array, _arg3:Array):void
        {
			...
			this._backLink = new ImageButton("list_back_btn_icon_down", 0, 0);//new ImageButton("list_back_btn_icon", 0, 0, false);
            this._backLink.onRelease.add(this.backLinkTouchHandler);
			//_backLink.onRelease.add(this.btnPresOnRelease);
            this._backLink.x = 90;
            this._backLink.y = 18;
            this._backLink.visible = false;
			addChild(this._backLink);
			
			this._openLink = new ImageButton("overlay_next_icon_down", 0, 0);//new ImageButton("list_back_btn_icon", 0, 0, false);
			this._openLink.onRelease.add(this.openLinkTouchHandler);
			this._openLink.x = 0;
			this._openLink.y = 18 + Constants.TOPBAR_HEIGHT;
			this._openLink.visible = false;
			GameBuilderApp.editor.addChild(this._openLink);
			...
			//Added for Models to show at startup
			var defaultCategory:MobileCategoryVO = new MobileCategoryVO();
			defaultCategory.id=7;
			defaultCategory.name="Hero";
			defaultCategory.name_en="Hero";
			defaultCategory.parent_id=0;
			defaultCategory.sort_index=0;
			defaultCategory.url_title="hero";
			
			mainCatListSelectHandler(defaultCategory);
        }
		
		private function openLinkTouchHandler(_arg1:ImageButton):void
		{
			var _local1:Tween = new Tween(GameBuilderApp.editor.leftPanel, 0.3, Transitions.EASE_OUT);
			_local1.animate("x", 0);
        ...
        {
			var _local1:Tween = new Tween(GameBuilderApp.editor.leftPanel, 0.3, Transitions.EASE_OUT);
			_local1.animate("x", -GameBuilderApp.editor.leftPanel.width);
			Starling.juggler.add(_local1);
			
			_openLink.visible = true;
//			this.parent.parent.addChild(this._openLink);
