package com.adobe.gamebuilder.editor.view.pages
{
    ...
    public class HelpPage3_2 extends HelpPage 
    {

        public function HelpPage3_2()
        {
            mainStep = 3;
            nextMainStep = 4;
            nextSubStep = 1;
        ...
        override protected function init():void
        {
            ...
            var _local7:Image = new Image(Assets.getTextureAtlas("Tutorial").getTexture("schritt3_2_1"));
            _local7.x = 3;
            _local7.y = _local2;
            _local5.addChild(_local7);
            _local2 = _local7.y;
            _local6 = Common.labelField(375, 90, Common.getResourceString("help3_2_1_text"), 18, "left", "top", false, Constants.BOLD_FONT);
            _local6.x = ((_local7.x + _local7.width) + 25);
            _local6.y = _local2;
            _local5.addChild(_local6);
            var _local8:uint = Math.ceil(((_local6.textBounds.width + 3) / 4));
            _local6 = Common.labelField(375, 60, (Common.nbsp(_local8) + Common.getResourceString("help3_2_2_text")));
            _local6.x = ((_local7.x + _local7.width) + 25);
            _local6.y = (_local2 + 2);
            _local5.addChild(_local6);
            _local2 = ((_local6.y + _local6.textBounds.height) + 20);
            _local6 = Common.labelField(375, 90, Common.getResourceString("help3_2_3_text"), 18, "left", "top", false, Constants.BOLD_FONT);
            _local6.x = ((_local7.x + _local7.width) + 25);
            _local6.y = _local2;
            _local5.addChild(_local6);
            _local8 = Math.ceil(((_local6.textBounds.width + 3) / 4));
            _local6 = Common.labelField(375, 60, (Common.nbsp(_local8) + Common.getResourceString("help3_2_4_text")));
            _local6.x = ((_local7.x + _local7.width) + 25);
            _local6.y = (_local2 + 2);
            _local5.addChild(_local6);
            _local2 = ((_local6.y + _local6.textBounds.height) + 20);
            _local6 = Common.labelField(375, 90, Common.getResourceString("help3_2_5_text"), 18, "left", "top", false, Constants.BOLD_FONT);
            _local6.x = ((_local7.x + _local7.width) + 25);
            _local6.y = _local2;
            _local5.addChild(_local6);
            _local8 = Math.ceil(((_local6.textBounds.width + 3) / 4));
            _local6 = Common.labelField(375, 60, (Common.nbsp(_local8) + Common.getResourceString("help3_2_6_text")));
            _local6.x = ((_local7.x + _local7.width) + 25);
            _local6.y = (_local2 + 2);
            _local5.addChild(_local6);
        }
