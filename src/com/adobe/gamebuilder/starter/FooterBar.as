package com.adobe.gamebuilder.starter
{
    ...
    public class FooterBar extends DisplayObjectContainer 
    {
        ...
        private function init(_arg1:Event):void
        {
            ...
            this.btnSave = new ImageButton("icon_plus", this._btnHighlight.width, this._btnHighlight.height);
            this.btnSave.x = (stage.stageWidth - (1 * this._btnHighlight.width))/2;
            this.btnSave.y = 0;
...
/*            this.btnHelp = new ImageButton("icon_help", this._btnHighlight.width, this._btnHighlight.height);
            this.btnHelp.x = (stage.stageWidth/2 - (2 * this._btnHighlight.width));
            this.btnHelp.y = 0;
            ...
            this.btnInfo.x = (stage.stageWidth/2 - this._btnHighlight.width);
            this.btnInfo.y = 0;
 ...
 //           this.separator((this.btnInfo.x - 1));
        ...
        {
			Dashboard(this.parent).goToEditor(null);
